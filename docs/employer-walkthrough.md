...
Open **Slate**, point out the compact desktop table, optional card view, and slate wind comparison.
Then open one matchup's details and narrate the evidence chain:
